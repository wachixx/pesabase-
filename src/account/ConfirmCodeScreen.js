         ...
         <Content>
            <Header  style={styles.header} androidStatusBarColor="#fb8c00" androidBarStyle="light-content">
             ...
             <View style={{marginBottom:50}}>
                <Text style={styles.headerTxt}>Confirm Code</Text>
                <Text style={styles.headerTxtDesc}>Please enter the code send to your phone number</Text>  
             </View>
             <View style={styles.loginFormWrapper}>
                 ...
                 <CodeInput
                    ...
                    autoFocus={true}
                    onFulfill={(code) => { this.state.code = code }}
                    />
                    </View>
                    <TouchableOpacity onPress={() => {navigate('PinScreen');}}>
