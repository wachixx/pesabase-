...
export default class MTNScreen extends React.Component {
    ...
    render() {
        ...
        return(
            ...
            <Container style = {styles.cont}>
                ...
                <Body><Text style={styles.title}>MTN</Text></Body>
                   ...
                   <View style={styles.menuContainer}>
                    ...
                    <View style={styles.wrapper}>
                        <View style={[styles.wrapper,{marginBottom:100}]}>
                            <Text style={{fontWeight:"bold",fontSize:16}}>MTN Money Transactions</Text>
